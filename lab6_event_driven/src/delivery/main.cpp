...
int main(int argc, char* argv[]) {
    userver::server::handlers::auth::RegisterAuthCheckerFactory<
        delivery_service::auth::jwt::JwtAuthCheckerFactory>();
    ...
    auto component_list = userver::components::MinimalServerComponentList()
                              ...
                              .Append<delivery_service::auth::jwt::JwtAuthComponent>()
                              .Append<userver::components::Postgres>("postgres-delivery-db")
                              .Append<userver::components::Secdist>()
                              .Append<userver::components::DefaultSecdistProvider>()
                              .Append<userver::components::Redis>("redis-delivery");

    delivery_service::delivery::AppendDeliveryHandlers(component_list);

    std::thread([] {
        delivery_service::delivery::ParcelEventConsumer consumer;
